...
rs.setName('motion_26');
let ht=50;


let topParams = {width:ht,height:ht,angleOffset:0*Math.PI/10,framePadding:-0.1*ht,frameStrokee:'white',frameStrokeWidth:.2,timePerStep:1/(64*32),stopTime:1,recordingMotion:1,saveAnimation:1,
    circleRadius:.2,nearestFadeFactor:20,shapesPerPath:64,speed:1,segsPerCircle:6,radius:.4*ht,numSlices:8,distanceThreshold:0};
...
rs.initialize = function () {
   debugger;
   this.initProtos();
   let {stopTime:stp,timePerStep:tps,lineP,circleP,radius,numSegs} = this;
  this.addFrame();
