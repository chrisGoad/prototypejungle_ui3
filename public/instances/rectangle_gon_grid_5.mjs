...
rs.setName('rectangle_gon_grid_5');
/*
let ht= 100;
let nr = 201;
...
rs.colors =[[0,250,0],[250,0,0],[250,0,0],[0,0,0],[0,250,0],[250,250,250],[0,0,0],[0,0,250],[0,250,0],[0,0,250],[0,250,0],[250,250,250],[0,0,250],[250,0,0],[250,250,250],[0,250,0]];
 rs.tfn = (v) => {
  let v0 =v[0];
  let v1 =v[1];
  let v2 =v[2];
