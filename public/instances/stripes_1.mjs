...
let topParams = {width:ht,height:ht,framePadding:0.1*ht,frameStrokee:'white',frameStrokeWidth:.2,numSteps:3*4*32,version:0};
...
rs.initialize = function () {
  ...
  let params = {stripeLength:48,stripeWidthFactor:0.2,bandWidths:bws,vertical:1,fill:'red',whereInBand:0};
