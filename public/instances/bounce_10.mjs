...
let topParams = {width:ht,height:ht,framePadding:0.1*ht,frameStroke:'rgb(2,2,2)',frameStrokeWidth:.2,timePerStep:0.15,stopTime:126,
...
rs.initialize = function () {
  ...
  this.mkCirclesForParticles(prta);
  this.currentTime = 0;
