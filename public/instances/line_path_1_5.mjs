...
rs.setTopParams = function () {
  ...
  cycleTime,part0tm,numSteps:2*part0tm+10,noNewPaths:8*cycleTime,lineLength:30,addPathInterval:30,fromOneSide:0,gap:0,saveAnimation:1	}
...
rs.pointsToShow =  rs.pointsOnSeg(50,LineSegment.mk(Point.mk(-fc*d,-fc*d),Point.mk(fc*d,fc*d))).concat(
                   rs.pointsOnSeg(50,LineSegment.mk(Point.mk(fc*d,-fc*d),Point.mk(-fc*d,fc*d))));
