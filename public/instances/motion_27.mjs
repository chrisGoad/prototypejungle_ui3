...
let topParams = {width:ht,height:ht,angleOffset:0*Math.PI/10,framePadding:-0.1*ht,frameStrokee:'white',frameStrokeWidth:.2,timePerStep:1/(32*32),stopTime:1,recordingMotion:1,saveAnimation:1,
    circleRadius:.2,nearestFadeFactor:20,shapesPerPath:16,speed:1,segsPerCircle:6,radius:.4*ht,numSlices:8,distanceThreshold:32};
...
rs.initialize = function () {
  ...
  let path0 = this.buildPath({radius,scaleX:1,scaleY:1,numSegs:40});
  let path1 = this.buildPath({radius:1.2*radius,scaleX:1,scaleY:1,numSegs:40});
