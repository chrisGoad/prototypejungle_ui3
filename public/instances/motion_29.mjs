...
9106*.5 = 13/4553
*/
let topParams = {width:ht,height:ht,angleOffset:0*Math.PI/10,framePadding:0.2*ht,frameStrokee:'white',frameStrokeWidth:.2,timePerStep:1/(32*32),stopTime:1,recordingMotion:1,
saveAnimation:1,numSegs:30,whereToPause:10000,
...
rs.initialize = function () {
 ...
 // this.paths = [cpath];
  ...
  let params1 = {speed,path:mpath1,startOffset:0,value:Point.mk(0,0)};
  let mp1 = this.mkActivePath(params1);;
  let params2 = {speed,path:mpath2,startOffset:0,value:Point.mk(0,0)};
  let mp2 = this.mkActivePath(params2)
  let params3 = {speed,path:mpath3,startOffset:0,value:Point.mk(0,0)};
