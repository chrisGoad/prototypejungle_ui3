...
let newParams = {width:ht,height:ht,numRows:nr,numCols:nr,randomColors:1,center:1,
                  framePadding:0.01*ht,frameStroke:'white',frameStrokeWidth:.1,saveAnimation:1,oneShot:1,
ULC:colors[0],URC:colors[1],LLC:colors[1],LRC:colors[0],CNC:colors[3],xgapf:.1,ygapf:.1};//50
