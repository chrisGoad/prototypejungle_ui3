...
let wd=100;
0
let topParams = {width:wd,height:wd,fr:.8,numSegs:100,drawLines:1,framePadding:0.3*wd,frameStroke:'rgb(2,2,2)',numSteps:96,saveAnimation:1,lineLength:1.8,lowStroke:[255,255,255],
