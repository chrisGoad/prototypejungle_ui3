...
rs.setName('drop_circles_14_5x7');
 let wd= 500;
 let ht = (7/5)*wd;
let nr = 40;
let topParams = {width:wd,height:ht,numRows:nr,numCols:nr,radius:100,frameStrokee:'white',framePadding:.1*ht}
...
rs.initialDrop = function () {
  let crc = Circle.mk(0.8*0.5*this.width);
  crc.isDisk = 0;
