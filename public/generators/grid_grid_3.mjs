...
let wd = 400;
let nr = 40;
let topParams = {saveState:1,width:wd,height:wd,numRows:nr,numCols:nr,pointJiggle:10,innerRows:2,innerCols:20};
...
rs.genEltDescription = function (n) {
  // let {innerRows,deltaX,rectP1,rectP2,innerPresent1,innerPresent2,saveState,whichElts,whichShape1,whichShape2} = this;
   let {innerRows,innerCols,deltaX,rectP1,rectP2,eltDState1,eltDState2,saveState} = this;
